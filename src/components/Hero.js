  ...
  return `
    ...
    <section class="hero-gradient" id="hero" style="position: relative; padding: 8.5rem 1.5rem 6.5rem; overflow: hidden; background: linear-gradient(180deg, rgba(15, 23, 42, 0.36) 0%, rgba(15, 23, 42, 0.45) 50%, rgba(15, 23, 42, 0.72) 100%), url('/assets/hero-prayas.jpg') center center/cover no-repeat; min-height: 85vh; display: flex; align-items: center; justify-content: center; box-shadow: inset 0 0 100px rgba(0,0,0,0.5);">
      ...
      <div class="container" style="position: relative; z-index: 10; width: 100%; max-width: 1240px; margin: 0 auto; text-align: center;">
        ...
        <h1 class="font-display font-extrabold tracking-tight" style="font-size: clamp(3.2rem, 7.5vw, 5.25rem); font-weight: 900; line-height: 1.35; margin-bottom: 2rem; color: #ffffff; text-align: center; letter-spacing: -0.02em; text-shadow: 0 6px 35px rgba(0,0,0,0.9), 0 2px 10px rgba(0,0,0,0.9);">
          ${isHi ? 'मुंबई पब्लिक स्कूल' : 'Mumbai Public School'}
        </h1>

        <!-- (CBSE & SSC) - Centered, Bold, Generous Spacing -->
        <h2 class="font-display font-bold" style="font-size: clamp(2.35rem, 5.5vw, 3.85rem); font-weight: 800; line-height: 1.35; margin-bottom: 0; color: #f8fafc; text-align: center; letter-spacing: -0.01em; text-shadow: 0 5px 30px rgba(0,0,0,0.85), 0 2px 8px rgba(0,0,0,0.9);">
          (CBSE & SSC)
        </h2>
        ...
        <div style="text-align: center; margin-top: 3.5rem; margin-bottom: 3.5rem;">
          <span class="school-managed-by-rgb" style="font-size: clamp(1.65rem, 4vw, 2.75rem); font-weight: 900; line-height: 1.4; letter-spacing: 0.02em; display: inline-block;">
        ...
        <div style="margin-bottom: 4rem;">
          <div style="display: inline-flex; align-items: center; justify-content: center; gap: 0.75rem; background: rgba(15, 23, 42, 0.65); border: 1.5px solid rgba(52, 211, 153, 0.5); padding: 0.75rem 2.25rem; border-radius: 9999px; backdrop-filter: blur(14px); -webkit-backdrop-filter: blur(14px); box-shadow: 0 8px 25px rgba(0,0,0,0.45);">
            ...
            <span style="font-size: clamp(1.1rem, 2.5vw, 1.35rem); font-weight: 700; color: #f8fafc; letter-spacing: 0.03em; line-height: 1.3;">
